...
export function Module(_props: {
  ...
  return (
    <>
    <div className="fixed inset-0 bg-gray-800 bg-opacity-20 z-40" />
      <section className="flex justify-center fixed top-10 left-1/4 z-50">
        <div className="p-8 px-12 bg-white-500 rounded w-5/6">
          ...
          <div className="flex justify-center">
            <button className="bg-black-400 p-3 px-16 font-medium rounded text-lg" onClick={_props.onModalOpen} >
              {_props.button}
            </button>
          </div>
        </div>

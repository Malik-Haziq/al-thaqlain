  ...
  return (
    <>
      <div className="bg-gray-300">
        <section className="bg-gray-300 py-12 mb-0">
          <div className="flex justify-between flex-wrap gap-3 mb-6 border-b-[1px] border-black-100 pb-10">
            <div>
              <img src={logo} className="h-24 mb-8 " alt="Al Thaqlain Logo" />
              <h2 className="text-lg font-medium mb-4 text-black-100">
            ...
            <div className="pt-6 cursor-pointer">
              <h3 className="text-xl mb-6 text-black-100">SERVICES</h3>
              <ul className="flex flex-col gap-3 text-white-200">
                <li className="hover:text-white-800">
            ...
            <div className="pt-6 cursor-pointer">
              <h3 className="text-xl mb-6 text-black-100">COMPANY</h3>
              <ul className="flex flex-col gap-3 text-black-200">
                <li className="hover:text-white-800">
            ...
            <div>
              <h3 className="text-xl mb-6 pt-6 text-black-100">CONTACT INFO</h3>
              <ul className="flex flex-col gap-3 text-white-200">
                ...
                <li className="hover:text-white-800 flex items-center gap-2">
          ...
          <div className="flex justify-between items-center gap-4 flex-col-reverse sm:flex-row">
            <p className="text-sm text-white-200 text-center">
              ...
              by&nbsp;
              <a
                className="text-secondary-100 hover:border-b-[1px] border-white-500 duration-150 font-medium"
